...
private void loadFile(JFrame frame) {
    ...
    loadButton.addActionListener(event -> {
        videoPath = "D:\\Project L3\\Traffic_Detector\\sample\\road_traffic.avi";
        field.setText(videoPath);
        capture = new VideoCapture(videoPath);
        capture.read(currentImage);
        videoFPS = capture.get(Videoio.CAP_PROP_FPS);
...
//        carsAmountField.setBackground(Color.YELLOW);
        ...
        carsSpeedField.setBackground(Color.YELLOW);
    ...
    private void infoVans(JFrame frame) {
        ...
        vansSpeedField.setBackground(Color.YELLOW);
    ...
    private void infoLorries(JFrame frame) {
        ...
        lorriesSpeedField.setBackground(Color.YELLOW);
    ...
    public void call(int event, Point point) {
        if (event == 1) {
            ...
            Imgproc.line(copiedImage, lineCount1, point, new Scalar(255, 0, 255), 1);
